...
\begin{enumerate}
  ...
  \item Να υπολογιστούν τα παρακάτω όρια κάνοντας άρση της απροσδιοριστίας, 
    ...
    \twocolumnside{
      \begin{enumerate}[i)]
        ...
        \item $\lim_{x\to 0}\frac{5x^{3}+8x^{2}}{3x^{4}-16x^{2}}$ 
          \hfill Απ: $-\frac{1}{2}$
  ...
  \item Να υπολογιστούν τα παρακάτω όρια στο άπειρο με χρήση κατάλληλων θεωρημάτων.
    ...
    \twocolumnside{
      ...
      \begin{enumerate}[i),start=3]
        ...
        \item $\lim_{x\to -\infty}\left(\frac{1-x^3}{x^2-7x}\right)^5$ 
          \hfill Απ: $\infty$
          % \item $\lim_{x\to \infty}\frac{2-x+\sin x}{1+\cos x}$ \qquad \textcolor{Col1}{Υπόδειξη:}
          %   Διαιρέστε με $x$ αριθμ. και παρονομ.  \hfill $-1$ 
      \end{enumerate}
    }
  ...
  \item Να υπολογιστούν τα παρακάτω όρια κάνοντας \textbf{άρση της απροσδιοριστίας} και
    χρήση του κανόνα L' Hospital.
