...
\geometry{top=20.25mm,bottom=30.25mm}
...
\begin{enumerate}
  \item Να υπολογιστούν τα αόριστα ολοκληρώματα.
    ...
    \begin{enumerate}[i)]
      ...
      \item $ \int \frac{1}{9x^{2}+4} \,{dx} $ 
        \hfill Απ: $ \frac{1}{6} \arctan(\frac{3x}{2}) $ 
      \item $ \int \frac{1}{\sqrt{9-(x-2)^{2}}} \,{dx} $ 
        \hfill Απ: $ \frac{1}{6} \arcsin(\frac{x-2}{3}) $ 
      \item $ \int \frac{1}{x^{2}+8x+20} \,{dx} $ \hfill Απ: $ \frac{1}{2}
        \arctan{\left(\frac{x+4}{2}\right)} $  
      \item $ \int \frac{1}{2x^{2}+2x+5} \,{dx} $ \hfill Απ: $ \frac{1}{3}
        \arctan{\left(\frac{2x+1}{3}\right)} $  
    \end{enumerate}
  }
