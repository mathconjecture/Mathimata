...
\begin{center}
\fbox{\large\bfseries  Ασκήσεις στις σειρές \textlatin{Laurent}}
\end{center}
...
\item (\textbf{Θέμα Εξετάσεων} με \boldmath{$z_0=-i$}\unboldmath) Αναπτύξτε σε σειρά \textlatin{Laurent} τη συνάρτηση $f(z)=\frac{1}{z(z-1)}$ σε όλους του πεπερασμένους δακτυλίους, γύρω από το $z_0=i$
