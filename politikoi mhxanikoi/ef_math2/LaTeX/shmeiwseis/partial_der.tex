...
\mythmm{Schwartz}{Αν για τη συνάρτηση $ f(x,y) $ υπάρχουν οι μερικές παράγωγοι 
...
\mydfn{Έστω η συνάρτηση $ f(x,y) $. Τα \textcolor{Col1}{ολικά διαφορικά 1ης και 
...
\twocolumnsidel{
  \[
    \xymatrix@C-10pt{ & & f \ar@{-}[dl]_{\mathlarger{\pdv{f}{x}}}^{\mathlarger{f_{x}}} 
