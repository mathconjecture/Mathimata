...
\begin{exercise}
  Να εγγραφεί σε κύκλο διαμέτρου $d$, ορθογώνιο με βάση $b$ και ύψος $h$
  ώστε το γινόμενο $ b h^{2} $ να είναι μέγιστο.
\end{exercise}
\begin{solution}
\item {}
  \twocolumnsidesccd{
...
\begin{exercise} 
  Να προσδιοριστεί ο λόγος της ακτίνας προς το ύψος ενός κλειστού
