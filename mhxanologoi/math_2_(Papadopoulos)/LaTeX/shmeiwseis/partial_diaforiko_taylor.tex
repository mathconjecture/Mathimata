...
\begin{rem}
  Από τη σχέση~\eqref{eq:efdiaf}, καταλαβαίνουμε ότι, μπορούμε να υπολογίσουμε 
...
\begin{solution}
  ...
  \begin{description}
    ...
    \item [B᾽ Τρόπος: (Με Ολοκλήρωση)] Αφού η παράσταση είναι τέλειο διαφορικό,  
      ...
      $k'(z) = 1 \Rightarrow k(z) = z + c_{1} \label{finally}$. Οπότε με αντικατάσταση 
      της~\eqref{finally} στην~\eqref{kz} βρίσκουμε 
      \begin{equation}
...
\begin{example}
  Να υπολογιστεί το ανάπτυγμα Taylor της συνάρτησης $f(x,y)=x^3+y^3+xy^2$ με κέντρο το 
