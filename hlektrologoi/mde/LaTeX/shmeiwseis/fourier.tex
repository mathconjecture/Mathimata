...
\newcommand{\twocolumnsiderp}[2]{\begin{minipage}[c]{0.50\linewidth}
    #1
...
\newcommand{\twocolumnsiderq}[2]{\begin{minipage}[c]{0.66\linewidth}
    #1
...
\twocolumnsiderq{
  ...
  \begin{dfn}
    ...
    σημείων ασυνέχειας \textlatin{(jump discontinuities}), στα οποία όμως, υπάρχουν τα 
    πλευρικά όρια και είναι πεπερασμένα .
  \end{dfn}
  \begin{rem}
    Αν $ x_{0} $ ένα τέτοιο σημείο ασυνέχειας, 
    τότε τα πλευρικά όρια της $f$ στο $ x_{0} $ από αριστερά και από δεξιά  
    συμβολίζονται, αντίστοιχα, με
    \begin{gather*}
      f(x_{0}^{-}) = \lim_{x \to x_{0}^{-}} f(x) \quad \text{και} \quad 
...
{\begin{tikzpicture}[scale=0.50]
    ...
    \draw[dashed,dash expand off,blue!50] (5.center) -- (o-|5) node[below] {$x_{1}$} ;
    \draw[dashed,dash expand off,blue!50] (2.center) -- (o-|2) node[below] {$x_{2}$} ;
...
\begin{dfn}
  ...
  η $f$ είναι τμηματικά συνεχής στο $[a,b]$, με σημεία ασυνέχειας \textlatin{(jumps)} 
  $ t_{i}, \; i=1,2,\ldots, n $ και είναι παραγωγίσιμη στα διαστήματα $ (t_{i},
  t_{i+1}), \; i=1,2,\ldots,n-1 $ (εκτός ίσως από πεπερασμένο πλήθος σημείων - γωνιακά
  σημεία) και υπάρχουν τα πλευρικά όρια της $ f' $ στα $ t_{i} $ και είναι πεπερασμένα.
\end{dfn}
...
\subsection*{Συνημιτονική σειρά \textlatin{Fourier} συνάρτησης με περίοδο $ 2 \pi $}
