...
%todo να προσθέσω το σημείο στον ορισμό
...
\begin{myitemize}
  ...
  \item $ \pdv{x}(\frac{f}{g}) = \frac{\pdv{f}{x} \cdot g - f \cdot \pdv{g}{x}}{g^{2}} $
\end{myitemize}
}
      ...
      \begin{align*}
        ...
        \twocolumnsidel{
          ...
          \[
            ...
            \pdv{y} {u} \pdv{y}{v} + \pdv{f}{x} \pdv[2]{x}{u}{v} + \pdv{f}{y} \pdv[2]{y}{u}{v} 
          \]
        }
