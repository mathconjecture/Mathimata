...
\begin{gather*}
  \begin{cases} 
    \displaystyle{\int _{- \pi }^{\pi} f(x) \cos{mx} \,{dx} = \frac{a_{0}}{2} \cdot 0 + a_{m} \int _{- \pi }^{\pi } \cos^{2}{mx} \,{dx} + b_{m} \cdot 0}, & m = 1,2,3, \ldots \\[0.5cm]
    \displaystyle{\int _{- \pi }^{\pi} f(x) \,{dx} = \frac{a_{0}}{2}} \int _{- \pi}^{\pi} \,{dx}, & m=0 \\
  \end{cases} 
  \intertext{άρα}
  \begin{cases} 
    \displaystyle{\int _{- \pi }^{\pi} f(x) \cos{nx} \,{dx} = a_{n}\cdot \pi }, \quad n=1,2,3\ldots \\[0.5cm]
    \displaystyle{\int _{- \pi }^{\pi} f(x) \,{dx} = \frac{a_{0}}{2} 2 \pi } 
  \end{cases} 
  \Leftrightarrow 
  \begin{cases} 
    \displaystyle{a_{n} = \frac{1}{\pi} \int _{- \pi }^{\pi } f(x) \cos{nx} \,{dx}}, \quad n=1,2,3\ldots \\[0.5cm]
...
\begin{rem}
  Οι συντελεστές Fourier μπορούν να υπολογιστούν σε \textbf{οποιαδήποτε} πλήρη 
  περίοδο. 
\end{rem}
...
\begin{thm}[Dircichlet]
  ...
  \[
    ...
    \begin{cases}
      ...
      \frac{f(x_{0}^{-})+ f(x_{0}^{+})}{2}, & \text{αν το $ x_{0} $ είναι σημείο \textbf{ασυνέχειας} της $f$} \\
      \frac{f(-\pi^{+})+ f(\pi^{-})}{2}, & \text{αν το $ x_{0} $ είναι \textbf{άκρο} του διαστήματος $ (-\pi,\pi) $} 
    \end{cases}
  \]
\end{thm}
